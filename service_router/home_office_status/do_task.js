...
var get_request_body = function(obj){
    ...
    body.geo_point = obj[id].location
    body.dev_key = "senz"
...
var get_home_office_status = function(body,id){

    /// 3 max retries
    var serv_url = url_generator.home_office_status_url
...
var start = function(request_id){
    ...
    promise.then(
        function (obj) {
            ...
            var service_promise = get_home_office_status(body);
